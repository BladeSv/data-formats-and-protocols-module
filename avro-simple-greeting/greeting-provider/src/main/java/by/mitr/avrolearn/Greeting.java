...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5573698506778439990L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"by.mitr.avrolearn\",\"fields\":[{\"name\":\"greeting\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"from\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Greeting(java.lang.String greeting, java.lang.String from) {
   ...
   */
  public static by.mitr.avrolearn.Greeting.Builder newBuilder() {
    return new by.mitr.avrolearn.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static by.mitr.avrolearn.Greeting.Builder newBuilder(by.mitr.avrolearn.Greeting.Builder other) {
    if (other == null) {
      return new by.mitr.avrolearn.Greeting.Builder();
    } else {
      return new by.mitr.avrolearn.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static by.mitr.avrolearn.Greeting.Builder newBuilder(by.mitr.avrolearn.Greeting other) {
    if (other == null) {
      return new by.mitr.avrolearn.Greeting.Builder();
    } else {
      return new by.mitr.avrolearn.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(by.mitr.avrolearn.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(by.mitr.avrolearn.Greeting other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public by.mitr.avrolearn.Greeting.Builder setGreeting(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public by.mitr.avrolearn.Greeting.Builder clearGreeting() {
      greeting = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public by.mitr.avrolearn.Greeting.Builder setFrom(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public by.mitr.avrolearn.Greeting.Builder clearFrom() {
      from = null;
