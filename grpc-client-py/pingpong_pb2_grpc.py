...
class PingPongServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ping = channel.unary_unary(
                '/by.mitr.grpc.PingPongService/ping',
...
def add_PingPongServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'by.mitr.grpc.PingPongService', rpc_method_handlers)
...
class PingPongService(object):
    ...
    def ping(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/by.mitr.grpc.PingPongService/ping',
